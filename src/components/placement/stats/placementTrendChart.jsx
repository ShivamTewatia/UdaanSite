...
export const PlacementTrendChart = () => {
  ...
  return (
    <ChartCard
    icon={<LineChart size={36} strokeWidth={2} />}
      ...
      <ResponsiveContainer width="100%" height="100%">
        <AreaChart data={trendData} margin={{ top: 10, right: 30, left: 0, bottom: 0 }}>
          ...
          <Area
            ...
            dot={{ r: 5, fill: CHART_COLORS.primary, stroke: "white", strokeWidth: 2 }}
            activeDot={{ r: 8, fill: CHART_COLORS.primary, stroke: "white", strokeWidth: 3 }}
          />
        </AreaChart>
      </ResponsiveContainer>
    </ChartCard>
