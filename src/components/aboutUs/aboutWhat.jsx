...
//               Our dedicated student teams work together to deliver comprehensive placement
...
const AboutWhat = () => {
  ...
  return (
    <div className={styles["teams-container"]} ref={sectionRef}>
        ...
        <div className={styles["content-container"]}>
          ...
          <div>
            {teams.map((team, teamIndex) => (
              <div
                key={teamIndex}
                className={`${styles["team-content"]} ${activeTeam !== teamIndex ? styles["team-hidden"] : ""}`}
              >
                <div className={`${styles["team-header-card"]} ${styles[`team-header-${getTeamColor(teamIndex)}`]}`}>
                  <div className={styles["team-header-content"]}>
                    <div className={`${styles["team-header-bar"]} ${styles[`bar-${getTeamColor(teamIndex)}`]}`}></div>
                    <div className={styles["team-header-text"]}>
                      <h2>{team.name} Team</h2>
                      <p>Discover the key roles and responsibilities</p>
                    </div>
